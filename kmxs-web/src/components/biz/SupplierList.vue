  ...
  <div class="supplier-container">
    ...
    >
      ...
      >
        ...
        <el-form-item label="公司编码" prop="supplierCode">
          <el-input v-model="form.supplierCode" style="width: 350px" />
        </el-form-item>
      </el-form>
    ...
    >
      ...
      />
      <el-table-column
        v-if="columns.visible('supplierCode')"
        prop="supplierCode"
        label="公司编码"
      />
    </el-table>
...
<script>
import crudItSupplier from "@http/system/itSupplier";
